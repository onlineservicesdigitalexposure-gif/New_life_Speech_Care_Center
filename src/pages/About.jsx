...
export default function About() {
    ...
    return (
        <div className="flex flex-col w-full">
            {/* Header */}
            <section className="relative shadow-sm section-padding py-24 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${AboutBg})` }}>
                <div className="absolute inset-0 bg-white/40"></div>
                <div className="container-custom text-center relative z-10">
                    <h1 className="heading-xl mb-4">{t('about.title')}</h1>
                    <p className="body-text text-xl max-w-2xl mx-auto">{t('about.subtitle')}</p>
                </div>
            </section>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
                        ...
                        <div className="lg:w-1/3 w-full sticky top-24">
                            <div className="relative mb-8 group">
                                ...
                                {/* RCI Badge */}
                                <div className="absolute -bottom-6 right-6 bg-white p-5 rounded-2xl shadow-xl shadow-gray-200 border border-gray-50 flex items-center gap-4 z-10 transition-transform duration-300 group-hover:scale-105">
                                    <ShieldCheck className="text-primary" size={32} strokeWidth={1.5} />
                                    <div>
                                        <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-0.5">Certified</p>
                                        <p className="text-gray-900 font-bold">{t('about.therapistCert')}</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:w-2/3 w-full space-y-16">
                            ...
                            <div>
                                ...
                                <p className="text-2xl text-primary font-medium mb-8">{t('about.therapistRole')}</p>
                            ...
                            <div className="relative group">
                                ...
                                <div className="bg-primary-50/50 p-10 rounded-3xl border border-primary-50 relative overflow-hidden z-10 transition-colors duration-300 group-hover:border-transparent">
                                    <Quote className="text-primary/10 absolute top-4 right-6 rotate-180" size={120} />
                                    <div className="relative z-10">
                                        <h3 className="heading-md mb-4">{t('about.philosophyTitle')}</h3>
                                        <p className="text-gray-700 italic text-xl leading-relaxed font-serif">
